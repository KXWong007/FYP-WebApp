                    ...
                    <form class="space-y-4 md:space-y-6" method="post" action="<?php echo e(route('login.action')); ?>">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="remember-me-checkbox">
                                <input type="checkbox" name="remember" id="remember" aria-describedby="remember" class="w-4 h-4 border border-gray-300 rounded bg-gray-700 focus:ring-3 focus:ring-primary-300 dark:ring-offset-gray-800" required="">
...
<?php /**PATH C:\Users\LAU\Desktop\finalfyp\fypv28112024\fyptest-Integrate\resources\views/auth/login.blade.php ENDPATH**/ ?>