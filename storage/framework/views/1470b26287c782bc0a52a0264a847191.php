        ...
        <button type="button" class="btn btn-custom btn-primary" id="import-btn">
            ...
            <div class="dropdown d-inline-block">
                ...
                <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                    <li><a class="dropdown-item" href="<?php echo e(route('reservations.export', ['type' => 'xlsx'])); ?>">
                        <i class="fas fa-file-excel me-2"></i>Excel (.xlsx)
                    </a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('reservations.export', ['type' => 'csv'])); ?>">
                        <i class="fas fa-file-csv me-2"></i>CSV
                    </a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('reservations.export', ['type' => 'pdf'])); ?>">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="single-row">
                            ...
                            <div class="mb-3 single-column">
                                ...
                                <input type="number" id="paymentId" name="paymentId" class="form-control">
                            </div>
                        </div>
...
<!-- Just before closing body tag -->
    ...
    <script src="<?php echo e(asset('js/reservation-calendar.js')); ?>"></script>
<?php $__env->stopSection(); ?>
...
<script>
    $(document).ready(function() {
        ...
        const reservation = <?php echo json_encode($editReservation, 15, 512) ?>;
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\miche\Downloads\finalfyp\finalfyp\fypv28112024\fyptest-Integrate\resources\views/reservation.blade.php ENDPATH**/ ?>