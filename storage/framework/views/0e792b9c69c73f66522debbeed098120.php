...
<?php $__env->startSection('content'); ?>
        ...
        <div class="filter-controls">
            ...
            <div class="category-filter">
                <select id="categoryFilter" class="form-control">
                    ...
                    <?php $__currentLoopData = $menus->pluck('category')->unique(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="menu-grid">
        <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="menu-card position-relative" data-id="<?php echo e($menu->dishId); ?>">
                <div class="dish-id"><?php echo e($menu->dishId); ?></div>
                <span class="availability-badge <?php echo e($menu->availability ? 'available' : 'unavailable'); ?>">
                    <?php echo e($menu->availability ? 'Available' : 'Not Available'); ?>

                </span>
                <img src="<?php echo e(asset('storage/' . $menu->image)); ?>" alt="<?php echo e($menu->dishName); ?>" class="menu-image">
                <div class="menu-content">
                    <div class="menu-title"><?php echo e($menu->dishName); ?></div>
                    <div class="menu-details">
                        <p><strong>Price:</strong> RM<?php echo e(number_format($menu->price, 2)); ?></p>
                        <p><strong>Category:</strong> <?php echo e(ucfirst($menu->category)); ?></p>
                        <?php if($menu->availableTime): ?>
                            <p><strong>Time:</strong> <?php echo e($menu->availableTime); ?></p>
                        <?php endif; ?>
                    </div>
                    <div class="menu-actions69">
                        <button class="edit-btn" data-id="<?php echo e($menu->dishId); ?>">
                            <i class="fas fa-edit"></i> Edit
                        </button>
                        <button class="delete-btn" data-id="<?php echo e($menu->dishId); ?>">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\miche\Downloads\finalfyp\finalfyp\fypv28112024\fyptest-Integrate\resources\views/menu.blade.php ENDPATH**/ ?>