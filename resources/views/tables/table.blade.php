...
@section('content')
    ...
    <div class="tables-actions mb-3">
        ...
        <!--<button type="button" class="btn btn-danger dropdown-toggle" type="button" id="exportDropdown" data-bs-toggle="dropdown">
            ...
            <li><a class="dropdown-item" href="{{ route('reservations.export', 'xlsx') }}">Excel (.xlsx)</a></li>
                <li><a class="dropdown-item" href="{{ route('reservations.export', 'csv') }}">CSV</a></li>
                <li><a class="dropdown-item" href="{{ route('reservations.export', 'pdf') }}">PDF</a></li>
            </ul>     
    </div>
    ...
    <div class="modal fade" id="addTablesModal" tabindex="-1" aria-labelledby="addTablesModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="addtables" form action="{{ route('table.store') }}" method="POST">
                @csrf
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-column justify-content-center align-items-center">
                <div id="qrCodeImageContainer" class="text-center mb-3" style="min-height: 50px;">
                    <!-- Placeholder for QR Code Image -->
                    <p class="text-muted">QR Code will appear here after generation.</p>
                </div>
                <button id="viewQRCodeBtn" type="button" class="btn btn-primary" style="display: none;">View QR Image</button>
            </div>
            <div class="modal-footer">
