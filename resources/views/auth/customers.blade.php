    ...
    <div class="customer-actions mb-3">
        ...
        <div class="dropdown d-inline">
            ...
            <ul class="dropdown-menu">
                <li>
                    <a class="dropdown-item export-item" href="{{ route('customers.export', ['type' => 'xlsx']) }}">
                        <i class="fas fa-file-excel me-2"></i>Excel (.xlsx)
                    </a>
                </li>
                <li>
                    <a class="dropdown-item export-item" href="{{ route('customers.export', ['type' => 'csv']) }}">
                        <i class="fas fa-file-csv me-2"></i>CSV
                    </a>
                </li>
                <li>
                    <a class="dropdown-item export-item" href="{{ route('customers.export', ['type' => 'pdf']) }}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <a href="{{ route('customers.template') }}" class="btn btn-dark">
