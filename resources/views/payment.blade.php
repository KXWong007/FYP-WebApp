        ...
        <button type="button" class="btn btn-custom btn-success" id="addPaymentBtn" data-bs-toggle="modal" data-bs-target="#addPaymentModal">
            ...
            <div class="dropdown d-inline-block">
                ...
                <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                    <li><a class="dropdown-item" href="{{ route('payments.export', ['type' => 'xlsx']) }}">
                        <i class="fas fa-file-excel me-2"></i>Excel (.xlsx)
                    </a></li>
                    <li><a class="dropdown-item" href="{{ route('payments.export', ['type' => 'csv']) }}">
                        <i class="fas fa-file-csv me-2"></i>CSV
                    </a></li>
                    <li><a class="dropdown-item" href="{{ route('payments.export', ['type' => 'pdf']) }}">
                                ...
                                <select id="reservationId" name="reservationId" class="form-control" required>
                                    ...
                                    @foreach($reservations as $reservation)
                                        <option value="{{ $reservation->reservationId }}" 
                                                data-customer-id="{{ $reservation->customerId }}"
                                                data-customer-name="{{ $reservation->name }}">
                                            {{ $reservation->reservationId }} - {{ $reservation->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
