    ...
    <div class="row mb-3">
        ...
        <div class="col-md-3">
            <div class="card custom-card bg-info">
                <div class="card-body">
                    <h2 class="card-title">{{ $pendingCount }}</h2>
        ...
        <div class="col-md-3">
            <div class="card custom-card bg-warning">
                <div class="card-body">
                    <h2 class="card-title">{{ $cookingCount }}</h2>
        ...
        <div class="col-md-3">
            <div class="card custom-card bg-success">
                <div class="card-body">
                    <h2 class="card-title">{{ $readytoserveCount }}</h2>
                        ...
                        <tbody>
                            @foreach($upcomingReservations as $reservation)
                                <tr class="reservation-row">
                                    ...
                                    <td>
                                        <i class="fas {{ $reservation->type_icon }}"></i> 
                                        {{ strtoupper($reservation->eventType) }}
                                    </td>
                        ...
                        <tbody>
                            @foreach($preparingOrders as $order)
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($order->started_at)->format('H:i:s') }}</td>
                                    <td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-striped" id="completedOrdersTable">
                        ...
                        <tbody>
                            @foreach($readyToServeOrders as $order)
                                <tr>
                                    <td>{{ $order->order_id }}</td>
                                    <td>{{ $order->table_number }}</td>
                                    <td>{{ $order->item_name }}</td>
