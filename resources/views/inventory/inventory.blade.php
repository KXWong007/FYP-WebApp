    ...
    <div class="inventory-actions mb-3">
        ...
        <div class="dropdown d-inline-block">
                ...
                <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                    <li><a class="dropdown-item" href="{{ route('inventory.export', ['type' => 'xlsx']) }}">
                        <i class="fas fa-file-excel me-2"></i>Excel (.xlsx)
                    </a></li>
                    <li><a class="dropdown-item" href="{{ route('inventory.export', ['type' => 'csv']) }}">
                        <i class="fas fa-file-csv me-2"></i>CSV
                    </a></li>
                    <li><a class="dropdown-item" href="{{ route('inventory.export', ['type' => 'pdf']) }}">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addinventory" method="POST" action="{{ route('inventory.store') }}">
                        @csrf
                        <!-- Inventory fields -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <a href="{{ route('inventory.template') }}" class="btn btn-dark">
